...
\newcommand{\myTime}{April 2024\xspace}
...
\hypersetup{%
    ...
    urlcolor=vertinge, linkcolor=vertinge, citecolor=vertinge, %pagecolor=RoyalBlue,%
...
%     borderline west={0.5mm}{0mm}{vertinge},
% 		arc=.5mm,
% 		title={\Large \textbf{Outline}}, coltitle=vertinge,
...
\begin{tcolorbox}[breakable,width=.9\textwidth
		,enhanced jigsaw, pad at break*=1mm, breakable,
    left=4mm, right=4mm, top=4mm, bottom=1mm, boxrule=0pt, frame hidden,
		 borderline south={0.5mm}{0mm}{vertinge},
		% borderline east={0.5mm}{0mm}{vertinge},
        % borderline west={0mm}{0mm}{vertinge},
		arc=.5mm,
		title={}, coltitle=vertinge,
		colback=LightBluebis, colbacktitle=LightBluebis
		% colbacktitle=Maroon
		]
}
