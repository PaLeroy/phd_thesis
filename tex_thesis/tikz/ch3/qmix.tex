...
\tikzstyle{netbox} = [rectangle, rounded corners, minimum width=1cm, minimum height=1cm, draw=black]
\tikzstyle{mixerbox} = [rectangle, rounded corners, thick, minimum width=4.8cm, minimum height=1.5cm, draw=black]
\tikzstyle{indixQbox} = [rectangle, rounded corners, thick, minimum width=1.3cm, minimum height=2cm, draw=black]
...
\node (indivQbox1) [indixQbox, below=of mixerbox, xshift=-1.2cm, yshift=-.5cm, label={[xshift=-.32cm, yshift=.2cm]$Q_{a_1}(\tau^1_t, u^1_t)$}] {$Q_{a_1}$};
\node (indivQboxn) [indixQbox, below=of mixerbox, xshift=1.2cm, yshift=-.5cm, label={[xshift=0.35cm, yshift=.2cm]$Q_{a_n}(\tau^n_t, u^n_t)$}] {$Q_{a_n}$};
...
\draw[thick, rounded corners, opacity=0.2] ($(indivQbox1.north west)$) rectangle ($(indivQbox1.south east)$);
\draw[thick, rounded corners, opacity=0.2] ($(indivQboxn.north west)$) rectangle ($(indivQboxn.south east)$);
\end{tikzpicture}