...
\centering
\includegraphics[width=.95\textwidth]{figures/ch7/tiny_heuristic_plot_qvmixmavenqmix.pdf}
...
\begin{subfigure}{\textwidth}
\centering
    \includegraphics[width=.95\textwidth]{figures/ch7/3s5z_tiny_perf_self_popu.pdf}
    \begin{subfigure}{.05\textwidth}
    \centering
    \caption*{}
    \end{subfigure}%
