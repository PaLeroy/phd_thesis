\captionsetup[subfigure]{justification=centering}
    \includegraphics[width=\textwidth]{figures/ch7/3m_tiny_six_qvmix_maven_qmix.pdf}
    ...
    \includegraphics[width=\textwidth]{figures/ch7/3s5z_tiny_six_qvmix_maven_qmix.pdf}
    \begin{subfigure}{.045\textwidth}
    \centering
    \caption*{}
    \end{subfigure}%
