...
\begin{figure}
    \centering
    \includegraphics[width=.8\textwidth]{figures/ch2/SG.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{figures/ch2/MDP.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{figures/ch2/POMDP.pdf}
