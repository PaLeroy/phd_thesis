\chapter{Fundations of multi-agent reinforcement learning} \label{ch:marl}
...
When there is a single agent learning in the environment, it is named Single-agent reinforcement learning (SARL).
