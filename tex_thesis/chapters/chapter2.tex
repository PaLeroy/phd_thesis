...
When agents are the same, they observe the state likewise, and a shortcut taken in the literature is to consider that these two sets $\mathcal{Z}$ and $\mathcal{O}$ are singleton.
