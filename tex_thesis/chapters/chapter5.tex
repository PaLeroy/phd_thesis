...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/ch5/imp_intro.pdf}
...
\centering
    \includegraphics[width=1\linewidth]{figures/ch5/fig2_mul/environments_v2_a.pdf}
    \caption{A k-out-of-n system environment.}
    \label{fig:env_categories_1}
\end{subfigure}%
\begin{subfigure}[t]{0.47\textwidth}
\centering
    \includegraphics[width=1\linewidth]{figures/ch5/fig2_mul/environments_v2_b.pdf}
...
\begin{subfigure}[t]{0.53\textwidth}
\centering
    \includegraphics[width=1\linewidth]{figures/ch5/fig2_mul/environments_v2_c.pdf}
    \caption{Uncorrelated and correlated initial damage distribution.}
    \label{fig:env_categories_3}
\end{subfigure}%
\begin{subfigure}[t]{0.47\textwidth}
\centering
    \includegraphics[width=1\linewidth]{figures/ch5/fig2_mul/environments_v2_d.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/ch5/plot_explain_plot_gaussian_2.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=.87\textwidth]{figures/ch5/boxplot_perc_limit.pdf}
